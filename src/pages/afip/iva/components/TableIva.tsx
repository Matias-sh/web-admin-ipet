...
export const TableIva = ({ data, isFetching, handleDelete }: Props) => {
    const columns: ICustomColumnItem[] = [
        ...
        { field: 'ivaPorcentaje', header: 'Porcentaje', sortable: true, filter: true, filterPlaceholder: 'Buscar Por Porcentaje', dataType: 'text' },
